...
<body class="fixed-left" id="crop-avatar">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <span>Dr. Appointments</span><span class="pull-right"><i class="md md-add"></i></span></a>
                         ...
                         <li class="has_sub">
                             <a class="waves-effect <?php if($this->router->fetch_class() == 'quotation'):echo"active";endif;?>" href="#"><i class="ion-clipboard"></i> 
                        <span>Quotations</span><span class="pull-right"><i class="md md-add"></i></span></a>
                            <ul class="list-unstyled">
                                <li><a href="#">Pending Quotation Req.</a></li>
                                <li class="<?php if($this->router->fetch_class() == 'quotation' && $this->router->fetch_method() != 'sendQuotation'):echo"active";endif;?>"><a href="<?php echo base_url();?>index.php/quotation">All Quotation Requests</a></li>
                                <li class="<?php if($this->router->fetch_class() == 'quotation' && $this->router->fetch_method() == 'sendQuotation'):echo"active";endif;?>"><a href="<?php echo base_url();?>index.php/quotation/sendQuotation">Send a Quote</a></li>
                                <li class="<?php if($this->router->fetch_class() == 'quotation' && $this->router->fetch_method() == 'quotationHistory'):echo"active";endif;?>"><a href="<?php echo base_url();?>index.php/quotation/quotationHistory">Quotation History</a></li>
                            </ul>
                        </li>
   ...
   <li class="has_sub ">
                        ...
                        <li>
                            <a class="waves-effect <?php if($this->router->fetch_class() == 'setting'):echo"active";endif;?>" href="<?php echo site_url('setting');?>"><i class="fa fa-cog"></i><span>Settings</span></a>
                        </li>
                    </ul>
