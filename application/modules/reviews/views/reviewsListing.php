                                ...
                                <div tabindex="5000" style="overflow: hidden;" class="inbox-widget nicescroll mx-box">
                                    <table class="table rating-table">
                                        <?php if(!empty($topRateds)):
                                          ...
                                          <tr>
                                            <td>
                                                <h6><img src="<?php if(!empty($rated->doctors_img)): echo base_url().'assets/doctorsImages/thumb/thumb_100/'.$rated->doctors_img;else: echo base_url().'assets/images/noImage.png'; endif;?>" alt="" class="img-responsive" width="65" height="65"/></h6>
                                            </td>
                                            <td>
