                    ...
                    <article class="clearfix p-t-20 appt-detail">
                        <aside class="col-md-6 col-sm-6">
                            ...
                            <div class="clearfix m-t-10">
                                ...
                                <p class="col-md-8"><?php if($doctorAppointment->doctorAppointment_status == 1){ echo "Pending"; }elseif($doctorAppointment->doctorAppointment_status == 2){ echo "Confirm"; }elseif($doctorAppointment->doctorAppointment_status == 3){ echo "Cancelled"; }else{ echo "Completed"; } ?></p>
                            </div>
