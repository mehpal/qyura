...
AND `healthPkgBooking_deleted` = 0';
    ...
    public function DoctorAppointmentList($now, $userId) {
      $sql3 = "SELECT  `qyura_users`.`users_username` as title,"
                    ...
                    . " CASE qyura_doctorAppointment.doctorAppointment_status WHEN '1' THEN 'pending' WHEN '2' THEN 'confirmed' WHEN '3' THEN 'Cancelled' WHEN '4' THEN 'Completed' ELSE '' END  AS `bookingStatus`,"
...
AND `healthPkgBooking_deleted` =0";
    ...
    public function DoctorAppointmentDetail($now, $userId,$orderId) {
       $sql3 = "SELECT  `qyura_users`.`users_username` as title,"
                    ...
                    ."CASE doctorAppointment_status WHEN '1' THEN 'pending' WHEN '2' THEN 'confirmed' WHEN '3' THEN 'Cancelled' WHEN '4' THEN 'Completed' ELSE '' END  AS `bookingStatus`,"
