...
// Ye nayan bhare bhare..
    ...
    function myNotification_post() {
        ...
        if ($this->bf_form_validation->run($this) == FALSE) {
            ...
            $SQL = "SELECT qyura_cronMsgId,qyura_cronMsg,qyura_cronDate,qyura_fkItemId,qyura_fkModuleId FROM qyura_cronMsgs WHERE qyura_fkUserId = ".$userId." AND qyura_cronDate <= CURRENT_TIMESTAMP ORDER BY qyura_cronDate ASC";
            
            $queryResult = $this->db->query($SQL)->result();
            $colName = array("msgId", "msgDetail","dateTime","itemId","type");
