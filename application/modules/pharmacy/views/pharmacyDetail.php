                        ...
                        <div class="bg-white">
                            ...
                            <section class="col-md-12">
                                ...
                                <aside class="clearfix m-bg-pic">
                                    ...
                                    <div class="bg-picture text-center" style="background-image:url('<?php if(isset($pharmacyData[0]->pharmacy_background_img) && !empty($pharmacyData[0]->pharmacy_background_img)): echo base_url().'assets/pharmacyImages/'.$pharmacyData[0]->pharmacy_background_img; else: echo base_url().'assets/default-images/Pharmacy.png'; endif;?>')">
...
<!--                                                        <input id="uploadBtn" type="file" class="upload" />-->
                                                    ...
                                                    <select class="form-control selectpicker" data-width="100%" name="pharmacy_stateId" onchange ="fetchCity(this.value)" id="pharmacy_stateId">
                                                          ...
                                                          <label class="control-label col-md-4" for="cname">Latitude & Longitude:</label>
                                                            <div class="col-sm-8">
                                                               <aside class="row">
                                                                   <div class="col-sm-6">
 <input class="form-control" name="lat" required="" type="text"  id="lat" readonly="" value="<?php echo $pharmacyData[0]->pharmacy_lat;?>" />
 ...
 <input class="form-control" name="lng" required="" type="text"   id="lng" readonly="" value="<?php echo $pharmacyData[0]->pharmacy_long;?>" />
