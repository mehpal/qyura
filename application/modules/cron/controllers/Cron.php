                    ...
                    switch ($n->userSocial_device){
                        case "2":
                            if($n->userSocial_pushToken != ""){
                                ...
                                $iosArray[] = array("title"=>$n->qyura_cronTitle,'msg'=>$n->qyura_cronMsg,"module_id"=>$n->qyura_fkModuleId,"item_id"=>$n->qyura_fkItemId,"device"=>$regIos, "cronMsgId"=>$n->qyura_cronMsgId);
                                break;
                            }
                        case "1":
                            if($n->userSocial_pushToken != ""){
                                ...
                                $androidArray[] = array("title"=>$n->qyura_cronTitle,'msg'=>$n->qyura_cronMsg,"module_id"=>$n->qyura_fkModuleId,"item_id"=>$n->qyura_fkItemId,"device"=>$regAnd, "cronMsgId"=>$n->qyura_cronMsgId);
