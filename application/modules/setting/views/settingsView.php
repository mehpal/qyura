            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="map_canvas"></div>
                     <form class="cmxform form-horizontal tasi-form" id="submitForm" name="submitForm" method="post" action="<?php echo site_url(); ?>/setting/config/<?php echo $users[0]->users_id;?>" novalidate="novalidate" enctype="multipart/form-data" >
                            ...
                            <div class="bg-white mi-form-section">
                                <article class="clearfix">
                                    <aside class="col-md-8">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <input type="email" class="form-control" id="users_email" name="users_email" placeholder="abc@gmail.com"  value="<?php if(!empty($users[0]->users_email)): echo ucwords($users[0]->users_email);endif;?>" readonly=""/>
