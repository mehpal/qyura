...
class Setting_model extends CI_Model {
    ...
    function getAdmin($userId = '') {
        ...
        $this->db->select('qyura_users.users_id,qyura_users.users_username,qyura_users.users_password,qyura_users.users_email,'
                        ...
                        . 'qyura_patientDetails.patientDetails_cityId,qyura_patientDetails.patientDetails_dob,qyura_patientDetails.patientDetails_address,qyura_patientDetails.patientDetails_pin')
                ->from('qyura_users')
