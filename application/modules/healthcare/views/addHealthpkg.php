                        ...
                        <div class="bg-white mi-form-section">
                            ...
                            <div class="clearfix m-t-20 p-b-20">
                                ...
                                <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="bestPrice" type="text" name="bestPrice" required="" placeholder="9000" onkeypress="return isNumberKey(event)" onkeyup="getDiscount(bestPrice.value, discountPercent.value)">
                                ...
                                <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="discountPercent" type="text" name="discountPercent" required="" placeholder="50%" maxlength="3" minlength="1" onkeypress="return isNumberKey(event)" onkeyup="getDiscount(bestPrice.value, discountPercent.value)" value="0">
                                 ...
                                 <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="discountPrice" type="text" name="discountPrice" required="" placeholder="7000" onkeypress="return isNumberKey(event)" readonly>
