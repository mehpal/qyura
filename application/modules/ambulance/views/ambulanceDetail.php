                                                   ...
                                                   ?>
                                                    <aside class="row">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-10 m-t-xs-10">
                                                            <input type="text" class="form-control" name="ambulance_phn[]" id="ambulance_phn<?php echo $i;?>" placeholder="9837000123" value="<?php if(isset($moreExpolde[1])){echo $moreExpolde[1];}?>" maxlength="10" onblur="checkNumber(<?php echo $i;?>)" onkeypress="return isNumberKey(event)"/>
